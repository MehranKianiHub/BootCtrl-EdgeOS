...
namespace forte::eclipse4diac::edgeml::test {
  ...
  struct ML_Filter_TestFixture : public forte::test::CFBTestFixtureBase {

      ML_Filter_TestFixture() : CFBTestFixtureBase("eclipse4diac::edgeml::ML_Filter"_STRID) {
        setInputData({&mIn0, &mIn1, &mIn2, &mIn3, &mAlpha, &mReset});
  ...
  BOOST_FIXTURE_TEST_SUITE(ML_FilterTests, ML_Filter_TestFixture)

  BOOST_AUTO_TEST_CASE(firstSamplePassThrough) {
    mIn0 = CIEC_REAL(1.0F);
    mIn1 = CIEC_REAL(2.0F);
    mIn2 = CIEC_REAL(3.0F);
    mIn3 = CIEC_REAL(4.0F);
    mAlpha = CIEC_REAL(0.5F);
  ...
  BOOST_AUTO_TEST_CASE(lowPassBehavior) {
    mIn0 = CIEC_REAL(0.0F);
    mIn1 = CIEC_REAL(0.0F);
    mIn2 = CIEC_REAL(0.0F);
    mIn3 = CIEC_REAL(0.0F);
    ...
    mIn1 = CIEC_REAL(10.0F);
    mIn2 = CIEC_REAL(10.0F);
    ...
    BOOST_TEST(checkForSingleOutputEventOccurence(0));
    BOOST_TEST(5.0F == static_cast<CIEC_REAL::TValueType>(mOut0));
    BOOST_TEST(5.0F == static_cast<CIEC_REAL::TValueType>(mOut1));
    BOOST_TEST(5.0F == static_cast<CIEC_REAL::TValueType>(mOut2));
    BOOST_TEST(5.0F == static_cast<CIEC_REAL::TValueType>(mOut3));
    BOOST_TEST(static_cast<CIEC_BOOL::TValueType>(mValid));
    BOOST_TEST(!static_cast<CIEC_BOOL::TValueType>(mError));
  }

  BOOST_AUTO_TEST_CASE(resetRestartsState) {
    mIn0 = CIEC_REAL(0.0F);
    mIn1 = CIEC_REAL(0.0F);
    mIn2 = CIEC_REAL(0.0F);
    mIn3 = CIEC_REAL(0.0F);
    mAlpha = CIEC_REAL(0.2F);
    mReset = CIEC_BOOL(false);
    triggerEvent(0);
    BOOST_TEST(checkForSingleOutputEventOccurence(0));
    ...
    BOOST_TEST(checkForSingleOutputEventOccurence(0));
    BOOST_TEST(5.0F == static_cast<CIEC_REAL::TValueType>(mOut0));
    BOOST_TEST(6.0F == static_cast<CIEC_REAL::TValueType>(mOut1));
    BOOST_TEST(7.0F == static_cast<CIEC_REAL::TValueType>(mOut2));
    BOOST_TEST(8.0F == static_cast<CIEC_REAL::TValueType>(mOut3));
  }

  BOOST_AUTO_TEST_CASE(invalidAlpha) {
    mIn0 = CIEC_REAL(1.0F);
    mIn1 = CIEC_REAL(1.0F);
    mIn2 = CIEC_REAL(1.0F);
    mIn3 = CIEC_REAL(1.0F);
    mAlpha = CIEC_REAL(1.2F);
    mReset = CIEC_BOOL(false);
