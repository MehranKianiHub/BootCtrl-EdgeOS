...
namespace forte::eclipse4diac::edgeml {
  ...
  class FORTE_ML_Normalize final : public CFunctionBlock {
      DECLARE_FIRMWARE_FB(FORTE_ML_Normalize)

    public:
      static constexpr CIEC_USINT::TValueType scmMethodMinMax = 0;
      static constexpr CIEC_USINT::TValueType scmMethodZScore = 1;

      static constexpr CIEC_USINT::TValueType scmErrorOk = 0;
      static constexpr CIEC_USINT::TValueType scmErrorNonFiniteInput = 1;
      static constexpr CIEC_USINT::TValueType scmErrorInvalidMinMaxRange = 2;
      static constexpr CIEC_USINT::TValueType scmErrorInvalidStdDev = 3;
      static constexpr CIEC_USINT::TValueType scmErrorUnknownMethod = 4;
    ...
    public:
      FORTE_ML_Normalize(StringId paInstanceNameId, CFBContainer &paContainer);

      CIEC_REAL var_IN;
      CIEC_USINT var_METHOD;
      CIEC_REAL var_MIN;
      CIEC_REAL var_MAX;
      CIEC_REAL var_MEAN;
      CIEC_REAL var_STDDEV;
      CIEC_BOOL var_CLAMP;
      ...
      CDataConnection *conn_METHOD;
      CDataConnection *conn_MIN;
      CDataConnection *conn_MAX;
      CDataConnection *conn_MEAN;
      CDataConnection *conn_STDDEV;
