...
namespace forte::eclipse4diac::edgeml {
  ...
  class FORTE_ML_FFT final : public CFunctionBlock {
      DECLARE_FIRMWARE_FB(FORTE_ML_FFT)
    ...
    public:
      FORTE_ML_FFT(StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      COutDataConnection<CIEC_REAL> conn_MAG_0;
      COutDataConnection<CIEC_REAL> conn_MAG_1;
      COutDataConnection<CIEC_REAL> conn_MAG_2;
      COutDataConnection<CIEC_REAL> conn_MAG_3;
