...
namespace forte::eclipse4diac::edgeml {
  ...
  class FORTE_ML_Filter final : public CFunctionBlock {
      DECLARE_FIRMWARE_FB(FORTE_ML_Filter)
    ...
    public:
      ...
      static constexpr CIEC_USINT::TValueType scmErrorInvalidAlpha = 2;
    ...
    public:
      FORTE_ML_Filter(StringId paInstanceNameId, CFBContainer &paContainer);
    ...
    private:
      std::array<CIEC_REAL::TValueType, scmVectorWidth> mPrevOutput;
      bool mInitialized;
  };
