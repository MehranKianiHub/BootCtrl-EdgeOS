...
namespace forte::eclipse4diac::edgeml {
  ...
  class FORTE_ML_AnomalyScore final : public CFunctionBlock {
      DECLARE_FIRMWARE_FB(FORTE_ML_AnomalyScore)

    public:
      static constexpr CIEC_USINT::TValueType scmErrorOk = 0;
      static constexpr CIEC_USINT::TValueType scmErrorNonFiniteInput = 1;
      static constexpr CIEC_USINT::TValueType scmErrorInvalidScale = 2;
    ...
    public:
      FORTE_ML_AnomalyScore(StringId paInstanceNameId, CFBContainer &paContainer);

      CIEC_REAL var_IN;
      CIEC_REAL var_REFERENCE;
      CIEC_REAL var_THRESHOLD;
      CIEC_REAL var_SCALE;

      CIEC_REAL var_SCORE;
      CIEC_BOOL var_IS_ANOMALY;
      CIEC_BOOL var_VALID;
      CIEC_BOOL var_ERROR;
      ...
      CDataConnection *conn_REFERENCE;
      CDataConnection *conn_THRESHOLD;
      CDataConnection *conn_SCALE;

      COutDataConnection<CIEC_REAL> conn_SCORE;
      COutDataConnection<CIEC_BOOL> conn_IS_ANOMALY;
