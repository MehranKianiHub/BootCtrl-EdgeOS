...
namespace forte::eclipse4diac::edgeml {
  ...
  class FORTE_ML_Softmax final : public CFunctionBlock {
      DECLARE_FIRMWARE_FB(FORTE_ML_Softmax)

    public:
      static constexpr CIEC_USINT::TValueType scmErrorOk = 0;
      static constexpr CIEC_USINT::TValueType scmErrorNonFiniteInput = 1;
      static constexpr CIEC_USINT::TValueType scmErrorInvalidTemperature = 2;
      static constexpr CIEC_USINT::TValueType scmErrorNumericalFailure = 3;
    ...
    public:
      FORTE_ML_Softmax(StringId paInstanceNameId, CFBContainer &paContainer);

      CIEC_REAL var_IN_0;
      CIEC_REAL var_IN_1;
      CIEC_REAL var_IN_2;
      CIEC_REAL var_IN_3;
      CIEC_REAL var_TEMPERATURE;
      ...
      CDataConnection *conn_TEMPERATURE;
